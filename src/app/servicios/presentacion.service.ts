...
export class PresentacionService {
  ...
  public detailName(nombre_y_apellido: string): Observable<Presentacion> {
    return this.http.get<Presentacion>(this.presentacionUrl + `detailname/${nombre_y_apellido}`);
  }
  ...
  public save(presentacion: Presentacion): Observable<Presentacion> {
    return this.http.post<Presentacion>(this.presentacionUrl + 'create', presentacion);
  }

  public update(id:number, presentacion: Presentacion): Observable<Presentacion> {
    return this.http.put<Presentacion>(this.presentacionUrl + `update/${id}`, presentacion);
  }

  public delete(id: number): Observable<Presentacion> {
    return this.http.delete<Presentacion>(this.presentacionUrl + `delete/${id}`);
  }
}

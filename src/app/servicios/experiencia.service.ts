...
export class ExperienciaService {
  ...
  public detailName(lugar_de_trabajo: string): Observable<Experiencia> {
    return this.http.get<Experiencia>(this.experienciaUrl + `detailname/${lugar_de_trabajo}`);
  }
  ...
  public save(experiencia: Experiencia): Observable<Experiencia> {
    return this.http.post<Experiencia>(this.experienciaUrl + 'create', experiencia);
  }

  public update(id:number, experiencia: Experiencia): Observable<Experiencia> {
    return this.http.put<Experiencia>(this.experienciaUrl + `update/${id}`, experiencia);
  }

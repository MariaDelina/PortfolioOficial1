...
constructor( certificaciones:string, info_de_instituto:string, url_logo_instituto:string,
            nombre_carrera:string, desde_periodo_ano:Date, hasta_periodo_ano:Date){

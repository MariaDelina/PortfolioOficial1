...
export class EditarPrincipalesProyectosComponent {
  ...
  constructor(
    ...
    private formulario: FormBuilder
      ...
      this.principalesProyectosService.detail(this.formId).subscribe(
      respuesta=>{
      console.log(respuesta);
      this.formularioPrincipalesProyectos.setValue({
        url_primer_proyecto_principal:respuesta['url_primer_proyecto_principal'],
        url_segundo_proyecto_principal:respuesta['url_segundo_proyecto_principal'],
      })
      }
      );
   ...
   enviarUrl():any{
     this.principalesProyectosService.update(this.formId, this.formularioPrincipalesProyectos.value).subscribe(()=>{
